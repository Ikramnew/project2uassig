...
<body style="background-color:rgb(53, 53, 53); color: #ffffff;">
    ...
    <footer id="footer" class="footer dark-background">
        <div class="container">
            ...
            <div class="container">
                <div class="copyright">
                    <span>Copyright</span> <strong class="px-1 sitename">The Map</strong> <span>All Rights Reserved</span>
                </div>
                <div class="credits">
                    Designed & Made by <a href="">Ikram Jundulloh</a> ~
                </div>
            </div>
        </div>
    </footer>
